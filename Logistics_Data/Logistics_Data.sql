...
-- This project is based on a logistics company data, such as data that could be found from FedEx, and UPS. 
...
-- We want to identify the customer id, customer name, and shipping address from customers who have placed an order. 
...
-- Identify the shipment id and shipping address for customers whose shipment has a status of "In Transit"
...
-- Display the name and email address for customers who have not used Express shipments so that we may send a discount code.
